        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-6">
            ...
            <li className="flex items-start gap-4">
              ...
              <a href="mailto:admin@ictechmedia.com" className="text-white/60 text-[16px] hover:text-secondary transition-colors duration-300">admin@ictechmedia.com</a>
            </li>
            <li className="flex items-start gap-4">
              <span className="material-symbols-outlined text-secondary">call</span>
              <a href="tel:+9779804089157" className="text-white/60 text-[16px] hover:text-secondary transition-colors duration-300">+977 9804089157</a>
            </li>
          </ul>
        </div>
      </div>
