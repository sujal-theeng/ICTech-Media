...
export default function Footer() {
  ...
  return (
    <footer ref={ref} className={`w-full bg-deep-charcoal text-white border-t-4 border-primary transition-all duration-700 ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-4'}`}>
      <div className="px-5 md:px-[64px] py-12 md:py-[80px] max-w-[1280px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-12 items-start">
          {/* Brand Section */}
          <div className="md:col-span-1">
            ...
            />
            <p className="text-white/60 mb-6 leading-relaxed text-[16px]">
            ...
            <ul className="space-y-6">
              <li>
                <a href="https://maps.google.com/?q=27.680185878643883,85.33423052999738" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 w-full group">
                  ...
                  <span className="text-white/60 text-[16px] hover:text-secondary transition-colors duration-300">Shankhamul, Kathmandu</span>
                </a>
              </li>
      ...
      <div className="border-t border-white/10 py-6 text-[12px] text-white/40 w-full flex justify-center">
